...
{ include("agenti_search_quadrant.asl") }      // idem
{ include("fetch_gold.asl") }           // plans for fetch gold goal
{ include("agenti_goto_depot.asl") }           // plans for go to depot goal
{ include("agenti_allocation_protocol.asl") }  // plans for the gold allocation protocol
